    ...
    <div className="min-h-screen bg-[#E9F1FB] p-4 lg:p-6">
      <div className="mx-auto 2xl:max-w-[1900px] space-y-4">
          ...
          <div className="flex flex-col lg:flex-row items-stretch lg:items-center gap-3 w-full lg:w-auto">
              ...
              <>
                <div className="flex flex-col lg:flex-row gap-3 w-full lg:w-auto">
                  <button
                    ...
                    onClick={handleSelfAssign}
                    disabled={assigning}
                    className="rounded-md bg-blue-600 px-4 py-2 text-sm text-white hover:bg-blue-700 disabled:opacity-50 whitespace-nowrap"
                  >
                    Self Assign
                  </button>
                  <button
                    ...
                    onClick={handleAssignToUser}
                    disabled={assigning || !selectedUser}
                    className="rounded-md border border-gray-300 px-4 py-2 text-sm hover:bg-gray-50 disabled:opacity-50 whitespace-nowrap"
                  >
                    Assign To
                  </button>
                </div>
            ...
            {isAssigned && (
              <button
                ...
                onClick={handleStartTask}
                disabled={submitting}
                className="rounded-md bg-blue-600 px-4 py-2 text-sm text-white hover:bg-blue-700 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2 w-full lg:w-auto"
              >
                {submitting ? (
                  <>
                    <div className="animate-spin rounded-full h-4 w-4 border-b-2 border-white"></div>
        ...
        <div className="rounded-lg border border-gray-200 bg-white p-4 lg:p-5">
          ...
          <div className="mt-4 grid grid-cols-1 lg:grid-cols-2 lg:grid-cols-5 gap-4">
            <div className="lg:col-span-2">
              <div className="text-xs font-medium text-gray-500">
                Order / SKU
              </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
          ...
          <div className="lg:col-span-2 rounded-lg border border-gray-200 bg-white overflow-hidden">
            <div className="flex flex-col lg:flex-row items-start lg:items-center justify-between border-b border-gray-200 px-4 lg:px-5 py-4 gap-3">
              <div className="text-sm font-semibold text-gray-900">
                Pick Steps
              </div>
              <div className="inline-flex items-center gap-2 rounded-full border border-gray-200 bg-gray-50 px-3 py-1 text-xs font-semibold text-gray-700">
              ...
              <table className="w-full text-sm">
                <thead className="bg-gray-50 text-xs font-semibold text-gray-500">
                  <tr>
                    ...
                    <th className="px-3 lg:px-5 py-3 text-left">Bin</th>
                    <th className="px-3 lg:px-5 py-3 text-left">SKU</th>
                    <th className="px-3 lg:px-5 py-3 text-left">Req</th>
                    <th className="px-3 lg:px-5 py-3 text-left">Picked</th>
                  ...
                  {steps.map((s) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-3 lg:px-5 py-4 font-semibold text-gray-900">
                          {s.bin}
                        </td>
                        ...
                        <td className="px-3 lg:px-5 py-4 text-gray-900">
                          {s.req}
                        </td>
                        <td className="px-3 lg:px-5 py-4 text-gray-900">
                          {s.picked}
          ...
          {/* Right: Scan & Confirm */}
          <div className="rounded-lg border border-gray-200 bg-white">
            <div className="flex items-center justify-between border-b border-gray-200 px-4 lg:px-5 py-4">
              <div className="text-sm font-semibold text-gray-900">
                Scan & Confirm
              </div>
              <button
        ...
        {isInProgress && (
          <div className="flex flex-col lg:flex-row gap-3 lg:gap-4 mt-8 pt-6 border-t border-gray-200">
            <button
              onClick={handleCompleteTask}
              disabled={submitting}
              className="flex-1 bg-green-600 text-white py-3 rounded-md font-medium hover:bg-green-700 transition-colors disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2"
            ...
            <button
              ...
              disabled={submitting || !qty || parseFloat(qty) <= 0}
              className="w-full lg:w-auto lg:px-6 border border-gray-300 text-gray-700 py-3 rounded-md font-medium hover:bg-gray-50 transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
            >
              Partial Pick
            </button>
          </div>
