...
const EditWarehouseModal = ({ isOpen, onClose, warehouse, onSuccess }) => {
  ...
  useEffect(() => {
    if (warehouse) {
      setFormData({
        ...
        capacity_sqft: warehouse.capacity_sqft?.toString() || "",
        timezone: warehouse.timezone || "Asia/Kolkata",
        warehouse_type: warehouse.warehouse_type || "DISTRIBUTION_CENTER",
        is_active: warehouse.is_active ?? true,
      });
      setOriginalPincode(warehouse.pincode || "");
    }
  }, [warehouse]);
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      const response = await http.put(`/warehouses/${warehouse.id}`, payload);
